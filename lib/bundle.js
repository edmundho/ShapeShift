...
class Board {
  ...
  drawPregame () {
    ...
    this.ctx.fillText(`shapeShift`, window.innerWidth / 2, 200);
  ...
  calculateAccuracy (keystrokes, wrongKeystrokes) {
    ...
    if (keystrokes.length === 0) { 
      ...
      // this.accuracy = ((allCorrectLetters.length - wrongKeystrokes.length)/allCorrectLetters.length * 100).toFixed(1);
    }
  }
