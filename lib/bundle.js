...
class Board {
  ...
  drawGameOver () {
    ...
    this.ctx.fillText(`Game Over...`, window.innerWidth/2, window.innerHeight/2 - 200);
...
class Game {
  ...
  registerListeners () {
    ...
    const toggleSound = document.getElementById('mute-button');
    toggleSound.addEventListener('click', this.toggleSound);
  }
