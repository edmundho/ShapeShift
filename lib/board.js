...
class Board {
  ...
  drawPregame () {
    ...
    this.ctx.fillText(`Score as many points as you can`, window.innerWidth / 2, window.innerHeight / 2 - 55);
    this.ctx.fillText(`by typing the word before the growing shape pops!`, window.innerWidth / 2, window.innerHeight / 2 - 25);
    this.ctx.fillText(`Ten 'popped' shapes and the game is over!`, window.innerWidth / 2, window.innerHeight / 2 + 35);
  }
