...
class Board {
  ...
  drawGUI() {
    ...
    this.ctx.fillText(`WPM: `, 210, 35);
    this.ctx.fillText(`Accuracy: `, 375, 35);
    this.ctx.fillText(`Score:   ${this.poppedShapes.length}`, 580, 35);
    this.ctx.fillText(`shapeShift`, 50, window.innerHeight - 35);
    this.ctx.fillText(`Type the word before the growing shape 'pops'!`, 200, window.innerHeight - 35);
  }
}
